...
data0 = pd.read_excel('data/tes.xlsx',header=[0,1])
...
features = [
    ...
    ('Career Average', 'REC TDs/GP'),
    ('Career Average', 'RECs/GP'),
    ('Career Best', 'REC Yards/ GP'),
    ('Career Best', 'REC TDs/GP'),
    ('Career Best', 'RECs/GP'),
    ('Career Last', 'REC Yards/ GP'),
    ('Career Last', 'REC TDs/GP'),
    ('Career Last', 'RECs/GP'),
    # ('Career Average', 'PPR/GP'),
    ('College DOM', 'TE CD'),
    ('Breakout Age', 'TE BOA '),
    ('NFL Stats, Finishes, and Milestones', 'Top 12 TE')
]
...
data[('NFL Stats, Finishes, and Milestones', 'Top 12 TE')].replace('-',0,inplace=True)

rank=[]
for n in data[('NFL Stats, Finishes, and Milestones', 'Top 12 TE')].values:
    if n <= 1:
        rank.append(0)
    else:
        rank.append(1)

data.drop([('NFL Stats, Finishes, and Milestones', 'Top 12 TE')],1,inplace=True)
data['eval'] = rank
